...
<link href="Script/css/conta.css" rel="stylesheet" type="text/css">
...
<div class="login_style" id="bg_logon"> 
  ...
  <img src="../image/UserArea.png">    </div>
    ...
    <div class="login_color" id="bg_central">
        ...
        <h1 style="font: italic small-caps bold 35px 'Verdana', sans-serif;"> Configurações da Conta </h1>
  		  <ul id="Center">
  		    <li><a href="atualizar_dados.php" style="font: italic small-caps bold 25px 'Verdana', sans-serif;">Atualizar Todos os dados da conta</a></li>
  		  <li><a href="alterar_senha.php" style="font: italic small-caps bold 25px 'Verdana', sans-serif;">Alterar Senha</a></li>

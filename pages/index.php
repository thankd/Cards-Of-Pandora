...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  $MM_redirectLoginSuccess = "logon.php";
...
}  else { $msg_erro = "Conta não ativada, Envie o email de confirmação <a style='color:red; text-decoration:none;' href='email_send.php'>aqui<a>"; }
...
function alter(i){
	...
	obj.innerHTML = "<img src='img/ddl_cartas/"+url_img+".png' />";
...
<tr>
<td><?php echo . $i . ?></td>
<td width='60px' align='center'><img src='img/1_lugar.png' width='20px' height='30px'></td>
...
<tr>
<td><?php echo . $i . ?></td>
<td width='60px' align='center'><img src='img/2_lugar.png' width='20px' height='30px'></td>
<td width='145px' align='left'>$Lista_Nome_Rank[$i]</td>
<td width='60px' align='left'>$Lista_Elo_Rank[$i]</td>
</td>
</tr>
...
<tr>
<td><?php echo . $i . ?></td>
<td width='60px' align='center'><img src='img/3_lugar.png' width='20px' height='30px'></td>
<td width='145px' align='left'>$Lista_Nome_Rank[$i]</td>
<td width='60px' align='left'>$Lista_Elo_Rank[$i]</td>
</td>
</tr>
  ...
  <div class="login_style" id="div_error"> <a> <?php echo $msg_erro; ?></a> </div>
    ...
    <form name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
      <p class="letras"><strong>E-mail</strong>
        <input name="login" type="text" id="login" size="10" class="bradiusLogin">
        <strong>Senha</strong>
        <input name="senha" type="password" id="senha" size="10" class="bradiusLogin">

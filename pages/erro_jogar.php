...
if(isset($_POST['cad_img']) && $_POST['cad_img'] == 'img'){
	...
	$foto = $_FILES["FotoURL"];
			...
			header("Location: erro_jogar.php");
}		
...
<link href="Script/css/erro_jogar.css" rel="stylesheet" type="text/css">
...
<div class="login_style" id="bg_logon"> 
  ...
  <img src="../image/UserArea.png">    </div>
    ...
    <div class="login_color" id="bg_central">
        ...
        <h1 style="font: italic small-caps bold 35px 'Verdana', sans-serif;">Seu deck não possui 8 cartas, coloque mais cartas usando as que estão na sua coleção! <br />  <br />
          clique <a href="inventario.php" style="text-decoration:none; color:white;">aqui</a> para ir a sua coleção</h1>
    </div>
